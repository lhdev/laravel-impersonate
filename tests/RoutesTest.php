...
class RoutesTest extends TestCase
{
    ...
    function it_adds_impersonate_route()
    {
        ...
        $this->assertTrue((bool)$this->routes->getByAction('LithiumDev\Impersonate\Controllers\ImpersonateController@take'));
    }
    ...
    function it_adds_leave_route()
    {
        ...
        $this->assertTrue((bool)$this->routes->getByAction('LithiumDev\Impersonate\Controllers\ImpersonateController@leave'));
    }
}
